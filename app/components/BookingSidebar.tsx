...
export default function BookingSidebar() {
  ...
  const fakeAvailability = useMemo(() => {
    return eventData.tickets.reduce((acc, ticket, index) => {
      acc[ticket.id] = 15 + ((index * 7) % 30); // 15-44 range, deterministic
      return acc;
          ...
          <div className="relative bg-white rounded-2xl p-4">
            ...
            <div className="mt-4 grid grid-cols-3 gap-2">
              <div className="bg-gray-50 rounded-lg p-2 text-center">
                ...
                <p className="text-[10px] text-gray-700">F: <span className="font-bold">₹2,999</span></p>
              </div>
              <div className="bg-gray-50 rounded-lg p-2 text-center">
                <p className="text-[9px] text-gray-400">5-9</p>
                <p className="text-[10px] text-gray-700">M: <span className="font-bold">₹3,399</span></p>
                <p className="text-[10px] text-gray-700">F: <span className="font-bold">₹2,899</span></p>
              </div>
              <div className="bg-gradient-to-r from-emerald-50 to-teal-50 rounded-lg p-2 text-center border border-emerald-200">
                ...
                <p className="text-[10px] text-emerald-700">M: <span className="font-bold">₹3,299</span></p>
                <p className="text-[10px] text-emerald-700">F: <span className="font-bold">₹2,799</span></p>
              </div>
            </div>
