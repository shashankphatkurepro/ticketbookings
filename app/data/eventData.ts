  ...
  tickets: [
    {
      id: "couple",
      name: "Couple Pass",
      description: "Entry for 2 adults with unlimited buffet & drinks",
      price: 4999,
      originalPrice: 6999,
      available: 150,
      maxPerOrder: 5,
    ...
    },
    {
      id: "family",
      name: "Family Pack",
      description: "2 Adults + 2 Kids with unlimited food & activities",
      price: 7999,
      originalPrice: 9999,
      available: 80,
      maxPerOrder: 3,
    ...
    },
    {
      id: "stag",
      name: "Stag Entry",
      description: "Single adult entry with buffet & soft drinks",
      price: 2999,
      originalPrice: 3999,
      available: 200,
      maxPerOrder: 4,
    ...
    },
    {
      id: "vip",
      name: "VIP Lounge",
      description: "Premium seating, private bar & priority access",
      price: 9999,
      originalPrice: 14999,
      available: 30,
      maxPerOrder: 2,
