      ...
      <div className="min-h-screen px-4 py-10">
        <div className="max-w-lg mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500">Send your payment screenshot to complete booking</p>
          </div>
            ...
            <div className="space-y-3 mb-4">
              {booking.items.map((item) => (
                <div key={item.ticketId} className="flex justify-between items-center p-3 glass-card rounded-xl">
                  <div>
                    <p className="font-medium text-gray-800">{item.ticketName}</p>
          ...
          {/* WhatsApp CTA */}
          <div className="glass-strong rounded-3xl p-6 mb-6 bg-gradient-to-br from-green-50 to-emerald-50">
            <div className="text-center mb-4">
              <h3 className="font-semibold text-gray-800 mb-2">Send Payment Screenshot</h3>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-4 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white rounded-2xl font-semibold text-lg shadow-lg shadow-green-500/25 hover:shadow-green-500/35 transition-all hover:-translate-y-0.5"
            >
          ...
          <div className="glass-strong rounded-3xl p-6 mb-6">
            ...
            <ol className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <p className="text-sm text-gray-600">Open WhatsApp and send your payment screenshot</p>
              </li>
              <li className="flex items-start gap-3">
                ...
                <p className="text-sm text-gray-600">We will verify your payment</p>
              </li>
              <li className="flex items-start gap-3">
                ...
                <p className="text-sm text-gray-600">Your tickets will be sent to you on WhatsApp</p>
              </li>
            </ol>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-4 glass-card hover:bg-gray-50 rounded-2xl text-gray-700 font-semibold text-lg transition-all"
          >
            Back to Home
          </button>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {step === 3 && (
              <div className="glass-strong rounded-3xl p-6 lg:p-8">
                ...
                {/* UPI Payment Section */}
                <div className="p-6 bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl mb-6">
                  {/* Amount to Pay */}
                  <div className="text-center mb-6">
                    <p className="text-sm text-gray-600 mb-1">Amount to Pay</p>
                    <p className="text-3xl font-bold text-gray-800">{formatPrice(totalAmount)}</p>
                  </div>
                  ...
                  <div className="flex justify-center mb-6">
                    <div className="bg-white p-4 rounded-2xl shadow-lg">
                      {upiQrCode ? (
                        <img src={upiQrCode} alt="UPI QR Code" className="w-56 h-56" />
                      ) : (
                        <div className="w-56 h-56 flex items-center justify-center bg-gray-100 rounded-xl">
                          <LoaderSpinner className="w-8 h-8 text-gray-400 animate-spin" />
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex justify-center gap-3 mb-6">
                    ...
                    <div className="w-12 h-12 rounded-xl bg-white shadow-sm flex items-center justify-center overflow-hidden">
                      <img src="https://www.upi.me/_next/image?url=%2Flogos%2Fgpay.png&w=96&q=75" alt="Google Pay" className="w-10 h-10 object-contain" />
                    </div>
                    {/* PhonePe */}
                    <div className="w-12 h-12 rounded-xl bg-white shadow-sm flex items-center justify-center overflow-hidden">
                      <img src="https://www.upi.me/_next/image?url=%2Flogos%2Fphonepe.png&w=96&q=75" alt="PhonePe" className="w-10 h-10 object-contain" />
                    </div>
                    {/* Paytm */}
                    <div className="w-12 h-12 rounded-xl bg-white shadow-sm flex items-center justify-center overflow-hidden">
                      <img src="https://www.upi.me/_next/image?url=%2Flogos%2Fpaytm.png&w=96&q=75" alt="Paytm" className="w-10 h-10 object-contain" />
                    </div>
                    {/* BHIM */}
                    <div className="w-12 h-12 rounded-xl bg-white shadow-sm flex items-center justify-center overflow-hidden">
                      <img src="https://www.upi.me/_next/image?url=%2Flogos%2Fbhim.png&w=96&q=75" alt="BHIM" className="w-10 h-10 object-contain" />
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-4 mb-4">
                    ...
                    <div className="flex items-center justify-between gap-2 bg-gray-50 rounded-lg p-3">
                      <code className="text-sm font-mono text-gray-800 truncate flex-1">{UPI_ID}</code>
                      <button
                        onClick={copyUpiId}
                  ...
                  <button
                    onClick={openUpiApp}
                    className="w-full py-3 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white rounded-xl font-semibold flex items-center justify-center gap-2 transition-all mb-4"
                  >
                ...
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-2xl mb-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-blue-800 mb-1">How to Pay</p>
                ...
                <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl">
                  ...
                  <div>
                    <p className="font-medium text-green-800">Secure UPI Payment</p>
                    <p className="text-sm text-green-600">Direct bank transfer via UPI - no card details needed</p>
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="p-5 space-y-5">
                ...
                {step < 3 ? (
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white rounded-2xl text-lg font-semibold shadow-lg shadow-green-500/25 flex items-center justify-center gap-2 disabled:opacity-70"
                  >
                    {isProcessing ? (
                      <>
